...
public class RobotContainer {
  ...
  private void configureBindings() {
    drivetrain.setDefaultCommand(
      new ArcadeDriveCommand(drivetrain, joystick1::getY, joystick1::getX
      )
    );
    JoystickButton popcornIntake = new JoystickButton(joystick1, 5);
    ...
    shoot.onTrue(new ShooterToggleCommand(shooter));
  ...
  public Command getAutonomousCommand() {
    ...
    return new ArcadeDriveCommand(drivetrain, ()-> 0.5, ()-> 0.0).withTimeout(4);// TODO: the robot is moving in the direction of the shooter
  }
}
